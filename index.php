...
if (isset($_POST['action'])) {
  switch($_POST['action']) {
    ...
    case 'toggle':
      ...
      $id = $_POST['id'];
      if(is_numeric($id)) {
        $updateQuery = 'UPDATE todo SET done = 1 AND done = 0  WHERE todo.id ="'.$_POST['id'].'" '; //*
    ...
    case 'delete':
      ...
      $id = $_POST['id'];
      if(is_numeric($id)) {
        $deleteQuery = '$deleteQuery = 'DELETE FROM todo WHERE todo.id ="'.$_POST['id'].'"';'; 
 ...
 */
$selectQuery = '$selectQuery = 'SELECT* FROM todo ORDER BY created_at DESC';'; 
